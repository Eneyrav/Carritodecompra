...
if(isset($_POST['button']) && isset($_FILES['attachment']))
{
	...
	$nombre = $_POST["nombre"]; //sender name
	$correo = $_POST["correo"]; //sender email, it will be used in "reply-to" header
	$subject	 = $_POST["subject"]; //subject for the email
	$mensaje	 = $_POST["mensaje"]; //body of the email
...
<body>
	<div style="display:flex; justify-content: center; margin-top:10%;">
		...
		<h3>Formulario<h3>
			...
			<div class="form-group">
				<input class="form-control" type="email" name="correo" placeholder="Correo del destinatario" required/>
			</div>
			<div class="form-group">
